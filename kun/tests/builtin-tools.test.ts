...
describe('Kun built-in tools', () => {
  ...
  it('supports pi-style configurable built-in tool factory APIs', async () => {
    ...
    expect(Object.keys(toolRecord).sort()).toEqual(['bash', 'edit', 'find', 'grep', 'ls', 'lsp', 'read', 'verify_changes', 'write'])
  ...
  it('exposes pi-style alias composition helpers and tool-name set', async () => {
    ...
    expect(Object.keys(allTools).sort()).toEqual(['bash', 'edit', 'find', 'grep', 'ls', 'lsp', 'read', 'verify_changes', 'write'])
    expect(Object.keys(allDefinitions).sort()).toEqual(['bash', 'edit', 'find', 'grep', 'ls', 'lsp', 'read', 'verify_changes', 'write'])
